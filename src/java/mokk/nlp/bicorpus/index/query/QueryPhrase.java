...
public class QueryPhrase {
     ...
     * @param stemmed2
     */
    public QueryPhrase(Field field, String[] terms, Qualifier qualifier, boolean stemmed) {
       this.field = field;
       this.terms = terms;
    ...
    public String toString() {
        ...
        buff.append( " ");
        buff.append(qualifier == Qualifier.SHOULD ? "SHOULD" : (qualifier == Qualifier.MUST ? "MUST" : "MUSTNOT") );
        buff.append( " ");
