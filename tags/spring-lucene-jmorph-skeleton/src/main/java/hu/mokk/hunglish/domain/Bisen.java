...
public class Bisen {
	...
	public static long countBisens() {
        return (Long) entityManager().createQuery("select count(o) from Bisen o").getSingleResult();
    }

	public static List<Bisen> findAllBisens() {
		throw new RuntimeException(new IllegalAccessException());
        //return null;//entityManager().createQuery("select o from Bisen o").getResultList();
    }
	...
	public static List<Bisen> findBisenEntriesByDoc(int firstResult, int maxResults, Doc doc) {
		return entityManager().createNativeQuery("select * from bisen where doc = "+doc.getId().toString(), Bisen.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
